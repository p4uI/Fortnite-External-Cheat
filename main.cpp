...
void render() {
	...
	if (Settings::Show_Menu) {
		...
		int current = 1;
		{
			...
			if (ImGui::Begin("APPLE CHEATS @ remade by noname big boss 😎  (INSERT)(menu is only usable in game)"), 0, ImGuiWindowFlags_::ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_::ImGuiWindowFlags_NoResize)
			{
				...
				else if (maintabs == 3)
				{
					...
					ImGui::Text("Proudly Made noname (alfa male)\n");
